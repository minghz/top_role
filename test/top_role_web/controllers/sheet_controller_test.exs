defmodule TopRoleWeb.SheetControllerTest do
  ...
  describe "index" do
    test "lists all character_sheets", %{conn: conn} do
      ...
      assert html_response(conn, 200) =~ "Listing Character sheets"
    end
  end
